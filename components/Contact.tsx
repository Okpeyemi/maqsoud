            ...
            <div className="max-w-[1400px] mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                    ...
                    <Link
                        ...
                        className="group bg-neutral-900/30 border border-neutral-800 p-8 rounded-2xl hover:bg-neutral-900/60 hover:border-orange-500/50 transition-all duration-300 flex flex-col items-center gap-4"
                    >
                        ...
                        <h3 className="font-hanken font-bold text-2xl text-white">Email</h3>
                        <span className="font-montserrat text-neutral-400 group-hover:text-white transition-colors">
                            maqsoudt9@gmail.com
                        </span>
                    </Link>

                    {/* Keybase / LinkedIn Block (User asked for LinkedIn but icon was generic in plan, will use LinkedIn) */}
                    <Link
                        href="https://linkedin.com/in/maqsoud-tawaliou"
                        target="_blank"
                        className="group bg-neutral-900/30 border border-neutral-800 p-8 rounded-2xl hover:bg-neutral-900/60 hover:border-blue-500/50 transition-all duration-300 flex flex-col items-center gap-4"
                    >
                        ...
                        <h3 className="font-hanken font-bold text-2xl text-white">LinkedIn</h3>
                        <span className="font-montserrat text-neutral-400 group-hover:text-white transition-colors">
                            Maqsoud Tawaliou
                        </span>
                    </Link>
                    ...
                    <Link
                        ...
                        target="_blank"
                        className="group bg-neutral-900/30 border border-neutral-800 p-8 rounded-2xl hover:bg-neutral-900/60 hover:border-white/50 transition-all duration-300 flex flex-col items-center gap-4"
                    >
                        ...
                        <h3 className="font-hanken font-bold text-2xl text-white">GitHub</h3>
                        <span className="font-montserrat text-neutral-400 group-hover:text-white transition-colors">
                            @Okpeyemi
                        </span>
                    </Link>
