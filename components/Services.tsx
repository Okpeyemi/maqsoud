                ...
                <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {services.map((service) => (
                        <FadeIn
                            ...
                            direction="up"
                        >
                            <div className="bg-neutral-900/50 border border-neutral-800 rounded-3xl p-6 lg:p-8 flex flex-col gap-6 hover:border-neutral-700 transition-colors group overflow-hidden h-full">
